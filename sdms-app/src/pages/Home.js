        ...
        <div className="flex flex-wrap mx-auto md:flex-nowrap">
          ...
          <a href="Tournament" className="w-full md:w-80 m-1">
            <div className="relative flex flex-col items-start transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
              ...
              <div className="px-6 py-8">
                ...
                <p className="mt-4 text-base font-normal text-gray-500 leading-relaxed">Follow live scores of the team you are following up on as results are updated by the organizer of the event real-time. Never miss a moment of an exciting tournament.</p>
              </div>
            </div>
          </a>
          ...
          <a href="Tournament" className="w-full md:w-80 m-1">
            <div className="relative flex flex-col items-start transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
              ...
              <div className="px-6 py-8">
                <h4 className="mt-4 text-2xl font-semibold text-neutral-600">
                  <span className="">Play an unlimited number of draws</span>
                </h4>
                <p className="mt-4 text-base font-normal text-gray-500 leading-relaxed">You can have an unlimited number of teams in a tournament, either Odd or Even, and the elimination method will lead the tournament to the final of the tournament. </p>
              </div>
            </div>
          </a>
          ...
          <a href="Tournament" className="w-full md:w-80 m-1">
            <div className="relative flex flex-col items-start transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
              ...
              <div className="px-6 py-8">
                ...
                <p className="mt-4 text-base font-normal text-gray-500 leading-relaxed"> we support the registration of any competitive sport that involves two players or teams playing against each other. The system will automatically create the draws for the sport </p>
              </div>
            </div>
          </a>
